...
<title>view basic info</title>
 ...
 <main>
 <h2>Basic Information: <?= htmlspecialchars($patient_full_name) ?></h2>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div><strong>Created At:</strong> <?= htmlspecialchars($data['created_at']) ?></div>
            <div><strong>Last Updated:</strong> <?= htmlspecialchars($data['updated_at']) ?></div>
        </div>
    </div>

    <a href="doctorNurse_edit_basic_info.php?user_id=<?= $user_id ?>" class="btn btn-pink">Edit Information</a>
  </main>
</div>
